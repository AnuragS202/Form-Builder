              ...
              <div key={field.id} className="mb-4">
                ...
                {field.type === "text" && (
                  <input
                    ...
                    } rounded-md shadow-sm -gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500`}
                  />
                )}
                {field.type === "textarea" && (
                  <textarea
                    ...
                    className={`w-full px-3 py-2 border ${
                      errors[field.id] ? "border-red-500" : "border-gray-300"
                    } rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500`}
                  />
                )}
                {field.type === "dropdown" && (
                  <select
